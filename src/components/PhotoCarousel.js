  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute start-6 top-1/2 z-30 hidden h-14 w-14 -translate-y-1/2 items-center justify-center rounded-full bg-stone-900/70 text-2xl text-white/80 transition-all duration-300 hover:bg-[#C7AC60] hover:text-white hover:shadow-[0_0_25px_rgba(199,172,96,0.3)] lg:flex"
      >
        {lang === "ar" ? "\u203A" : "\u2039"}
      </button>
      ...
      <button
        ...
        className="absolute end-6 top-1/2 z-30 hidden h-14 w-14 -translate-y-1/2 items-center justify-center rounded-full bg-stone-900/70 text-2xl text-white/80 transition-all duration-300 hover:bg-[#C7AC60] hover:text-white hover:shadow-[0_0_25px_rgba(199,172,96,0.3)] lg:flex"
      >
        {lang === "ar" ? "\u2039" : "\u203A"}
      </button>
      ...
      <div className="absolute bottom-8 left-0 right-0 z-30 flex items-center justify-center gap-6 lg:hidden">
        <button
          onClick={lang === "ar" ? handleNext : handlePrev}
